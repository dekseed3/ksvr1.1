...
class TenderAdminController extends Controller
{
  public function __construct()
  {
    ...
    public function index()
    {
      ...
      return view('manage.tender.index')->withTenders($tenders);
    ...
    public function create()
    {
        ...
        return view('manage.tender.create')->withCate_tenders($cate_tenders);
    }
    ...
    public function edit($id)
    {
      ...
      return view('manage.tender.edit')->withTenders($tenders)->withCate_tenders($cate_tenders);
    }
