  ...
  <div class="container">
    ...
    <hr class="m-t-0">
              ...
              @if ($errors->count() > 0)
                   ...
                   @endforeach
              @endif
       <form id="update" action="{{ route('tenders-admin.update', $tenders->id)}}" method="POST" enctype="multipart/form-data">
           {{ csrf_field() }}
           {{ method_field('PUT') }}
      <div class="columns">
        <div class="column">
        ...
        <b-field horizontal label="ไฟล์ดาวห์โหลด :">
          ...
          <div class="field">
            <p class="control">
              <input class="input is-static" value="{{$tenders->file}}" readonly><b-input type="file" name="file" class=""></b-input>
            </p>
          </div>
        </div>
        ...
        <b-field horizontal><!-- Label left empty for spacing -->
            <p class="control">
                ...
                <a href="{{route('tenders-admin.index')}}" class="button is-active">
