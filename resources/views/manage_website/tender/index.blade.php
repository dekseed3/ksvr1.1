...
@section('content')
  ...
  <div class="container">
    <div class="columns m-t-10">
      ...
      <div class="column">
        <a href="{{route('tenders.create')}}" class="button is-link is-pulled-right button-link-manage">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="has-text-centered">
                <a href="{{ route('tenders.edit', $tender->id)}}" class="button is-link"><i class="far fa-edit btn-xs"></i></a>
                  <form id="delete" name="delete" action="{{ route('tenders.destroy', $tender->id)}}" method="POST" onsubmit='return ConfirmDelete()'>
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
